...
namespace MENU
{
	namespace PPGUI_PP_GUI
	{
		...
		void Menu::DrawMouse(Vector2D pos)
		{
			...
			RENDER::DrawLine(pos.x + 9, pos.y + 15, pos.x + 11, pos.y + 20, WHITE);
			RENDER::DrawLine(pos.x + 7, pos.y + 14, pos.x + 10, pos.y + 21, WHITE);

			RENDER::DrawLine(pos.x, pos.y, pos.x, pos.y + 20, BLACK);
			RENDER::DrawLine(pos.x, pos.y + 20, pos.x + 6, pos.y + 17, BLACK);

			RENDER::DrawLine(pos.x + 7, pos.y + 18, pos.x + 10, pos.y + 22, BLACK);
			RENDER::DrawLine(pos.x + 8, pos.y + 18, pos.x + 10, pos.y + 22, BLACK);

			RENDER::DrawLine(pos.x + 10, pos.y + 21, pos.x + 13, pos.y + 21, BLACK);

			RENDER::DrawLine(pos.x + 13, pos.y + 21, pos.x + 10, pos.y + 15, BLACK);

			RENDER::DrawLine(pos.x + 10, pos.y + 15, pos.x + 16, pos.y + 16, BLACK);

			RENDER::DrawLine(pos.x + 16, pos.y + 15, pos.x, pos.y, BLACK);
		}
